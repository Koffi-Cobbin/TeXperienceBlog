    ...
    def send(self):
        return requests.post(
            ...
            data = {
                ...
                "to": self.user_email,
                "aubject": "The price limit for {} has been reached!!!".format(self.item.name),
                "text": "Hurreeey!, We found a deal! ({}). To view the alert, visit {}".format(self.item.url, "https://pricing.pheelstore.com/alerts/{}".format(self._id))
            }
        )

    @classmethod
    def find_pending_update(cls, minutes_since_update=AlertConstants.ALERT_TIMEOUT):
